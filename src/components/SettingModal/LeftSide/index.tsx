  ...
  return (
    <div className="w-[256px] flex-shrink-0">
      ...
      <div className=" w-full flex flex-col items-start gap-2 ">
        <div onMouseEnter={() => setHoverIcon(true)} onMouseLeave={() => setHoverIcon(false)} className="w-full">
          <Button
            text="Account details"
            type="button"
            onClick={() => {}}
            className="!w-full !px-5 !py-[14px]  !gap-[10px] !font-medium bg-transparent !text-black hover:bg-blue-100 hover:!text-blue-700 "
            icon={<UserIcon color={hoverIcon ? "#274C9B" : "#000000"} />}
          />
        </div>
        <div onMouseEnter={() => setHoverIcon1(true)} onMouseLeave={() => setHoverIcon1(true)} className="w-full">
          <Button
            text="Projects"
            type="button"
            onClick={() => {}}
            className="!w-full !px-5 !py-[14px] !gap-[10px] bg-blue-100 !font-medium !text-blue-700 hover:bg-blue-100 hover:!text-blue-700"
