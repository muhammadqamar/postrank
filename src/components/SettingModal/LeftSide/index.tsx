      ...
      <div className=" w-full flex flex-col items-start gap-2 ">
        ...
        >
          <Button
            ...
            type="button"
            onClick={() => {}}
            className="!w-full !px-5 !py-[14px]  !gap-[10px] !font-medium bg-transparent !text-black hover:bg-lightBlue hover:!text-blue-700 "
            icon={<UserIcon color={hoverIcon ? "#274C9B" : "#000000"} />}
          />
        </div>
        <div
          onMouseEnter={() => setHoverIcon1(true)}
          onMouseLeave={() => setHoverIcon1(true)}
          className="w-full"
        >
          <Button
            text="Projects"
            type="button"
            onClick={() => {}}
            className="!w-full !px-5 !py-[14px] !gap-[10px] bg-lightBlue !font-medium !text-blue-700 hover:bg-lightBlue hover:!text-blue-700"
        ...
        >
          <Button
            ...
            type="button"
            onClick={() => {}}
            className="!w-full !px-5 !py-[14px] !gap-[10px] bg-transparent !font-medium !text-black hover:bg-lightBlue hover:!text-blue-700 "
