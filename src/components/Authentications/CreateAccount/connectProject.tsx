    ...
    <div className="pt-[87px] max-w-[320px] min-h-screen mx-auto">
      ...
      <div className="mb-[42px]">
        <div className="flex justify-between items-center mb-5">
          <TextTag as="p" text={'Google Analytics'} className={'p-small'} color={'text-textGray'} />
          <Link to={'/#'}>
            <Button text={'Connect'} onClick={() => {}} type={undefined} className="text-customBlue bg-white border-2 border-solid border-customBlue !py-[7px] !px-3" />
          </Link>
        </div>
        <Formik
          initialValues={{
